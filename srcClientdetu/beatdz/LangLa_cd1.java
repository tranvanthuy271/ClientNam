    ...
    public LangLa_cd1(MainScreen var1, Message var2) {
        ...
        try {
            ...
            try {
                ...
                String[] var11 = Utlis.split(Binary.a("http://langlaall.com/text_mod.txt", 2), "\n"); //sửa text mod
            ...
            String str = Binary.a("http://langlaall.com/checkmod.txt", 2);
        ...
        switch (var1.b) {
            ...
            case 2907:
                if (Gdx.app.getType() == com.badlogic.gdx.Application.ApplicationType.Android) {
                    Gdx.net.openURI("https://langlaall.com/taigameallserver/LangLaClient.apk");
                } else if (Gdx.app.getType() == com.badlogic.gdx.Application.ApplicationType.Desktop) {
                    Gdx.net.openURI("https://langlaall.com/taigameallserver/LangLaClient.zip");
                }
